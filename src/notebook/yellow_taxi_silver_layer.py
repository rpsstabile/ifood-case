...
SOURCE_SYSTEM = "yellow_taxi"

BRONZE_PATH = (
    "/Volumes/main/ifood/ifood_case/bronze/yellow_taxi"
)
...
QUARANTINE_PATH = (
    "/Volumes/main/ifood/ifood_case/quarantine/yellow_taxi"
)
...
for file in new_files:
    ...
    # Exemplo:
    # /bronze/yellow_taxi/2023-04/yellow_tripdata_2023-04.parquet
...
spark.sql("""
CREATE TABLE IF NOT EXISTS main.ifood.yellow_taxi_silver
USING DELTA
AS
SELECT *
FROM delta.`/Volumes/main/ifood/ifood_case/silver/yellow_taxi`
""")
...
spark.sql("""
CREATE TABLE IF NOT EXISTS main.ifood.yellow_taxi_quarantine
USING DELTA
AS
SELECT *
FROM delta.`/Volumes/main/ifood/ifood_case/quarantine/yellow_taxi/`
""")